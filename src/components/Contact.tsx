const Contact = () => {
  return (
    <div className="flex flex-col gap-4 1/3">
      <h2 className="text-white font-semibold text-[2rem] leading-11 font-noto">
        Contact us
      </h2>
      <div className="py-8 border-y border-[#454545] ">
        <p className="text-[#CACACA] font-medium text-xl leading-8 font-noto">
          For more information about supporting the Museum:
        </p>
        <div>
          <p className=" font-normal text-xl leading-10 font-noto">
