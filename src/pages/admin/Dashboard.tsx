...
const Dashboard = () => {
  return (
    <div className="bg-[#121418] px-5 xl:px-10 pt-10">
      <div className="flex bg-[#191B20] px-15 py-10">
        <div>
          <p className="font-bold text-2xl xl:text-3xl leading-10 font-noto text-white mb-5">
      ...
      <div className="my-12">
        <h1 className="font-bold text-2xl xl:text-[2rem] leading-10 font-noto text-white">
          Admin Dashboard
        </h1>
        <div>
          <Table />
